      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900">
            {step === 'type' ? 'New Conversation' : conversationType === 'group' ? 'Create Group' : 'New Direct Message'}
          </h3>
          <button
            onClick={handleClose}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {selectedUsers.map(selectedUser => (
                      <div key={selectedUser.id} className="flex items-center justify-between p-2 bg-primary-light rounded-lg">
                        <div className="flex items-center space-x-2">
                          {selectedUser.photoURL ? (
                            <img src={selectedUser.photoURL} alt={selectedUser.displayName} className="w-8 h-8 rounded-full" />
                          ) : (
        ...
        {step === 'details' && (
          <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <button
              ...
              disabled={creating || selectedUsers.length === 0 || (conversationType === 'group' && !groupName.trim()) || (conversationType === 'direct' && selectedUsers.length !== 1)}
